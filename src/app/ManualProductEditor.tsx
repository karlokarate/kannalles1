    ...
    <section className="manual-card" aria-labelledby="manual-title">
      ...
      <div className="manual-grid">
        ...
        {referenceMode === 'per100' ? <>
          ...
          <div className="field"><span>Anzahl {unitLabel(servingUnit)}</span><QuantityStepper value={servingCount ?? 1} min={0.01} max={10_000} onChange={(amount) => setUnitCount(String(amount))} ariaLabel={`Anzahl ${unitLabel(servingUnit)}`} testId="manual-unit-count" /></div>
