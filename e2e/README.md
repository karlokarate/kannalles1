...
The retained non-network coverage verifies the app shell, accessible navigation, mobile reflow, WCAG A/AA smoke checks, deterministic manual calculation and the local SQLite product path. Gateway, account and mocked product-API journeys are intentionally absent.
